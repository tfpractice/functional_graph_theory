...
const addEdgeR = (edges = new Map, [src, nb, wt = 0]) => edges
...
const importEdge = (edges = new Map, [src, alts = new Map]) =>
	addMap(diff(spreadK(alts))(edges)
		.reduce(addSrc, edges), [src, mapUnion(edges.get(src))(alts)]);
// return addMap(edges, [src, mapUnion(edges.get(src))(alts)]);
// };
