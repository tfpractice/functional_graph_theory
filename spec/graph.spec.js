describe('Graph', function() {
    ...
    describe('when given a collection of elements', () => {
        ...
        describe('makeGraph(...elements)', () => {
            it(
                'returns a new object with nodes and edges',
                () => {
    ...
    describe('operators', () => {
        ...
        describe('showGraph(graph)', () => {
            it(
                'returns a string representation the graph',
                () => {
        ...
        describe('addNodes', () => {
            it(
                'adds a node and edges entry for each additional node',
                () => {
        ...
        describe('mergeGraphs(n0)(n1,weight)', () => {
            it('merges nodes and edges of two graphs',
                () => {
                    ...
                    expect(nodes(evenGraph).has(n15))
                        .toBeTrue();
                });
        });
    });
